/// Example application demonstrating the routing abstraction with AutoRoute.
///
/// This example shows:
...
void main() {
  runApp(const ExampleAutoRouteApp());
}

class ExampleAutoRouteApp extends StatefulWidget {
  const ExampleAutoRouteApp({super.key});

  @override
  State<ExampleAutoRouteApp> createState() => _ExampleAutoRouteAppState();
}

class _ExampleAutoRouteAppState extends State<ExampleAutoRouteApp> {
  ...
  /// Shell builder for AutoRoute - receives AutoRouteShellData with route info
  Widget _buildShell(
    BuildContext context,
      ...
      body: ListView(
        ...
        children: [
          _InfoCard(
            ...
            description: 'This example uses AutoRouteAdapter instead of '
                'GoRouterAdapter. The same AppRouter interface works with both!',
          ),
          const SizedBox(height: 16),
          _NavigationCard(
            title: 'User Profile',
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          const _SettingsSection(title: 'Privacy'),
          ListTile(
          ...
          ListTile(
            ...
            subtitle: const Text('1.0.0 (AutoRoute)'),
          ),
          const Divider(),
          ListTile(
