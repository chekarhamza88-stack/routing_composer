...
import '../core/routing/adapters/adapters.dart';
import '../core/routing/domain/domain.dart';
import '../core/routing/routes/app_routes.dart';
...
class _ExampleAppState extends State<ExampleApp> {
  ...
  Widget _buildShell(BuildContext context, dynamic state, Widget child) {
...
class LoginPage extends StatefulWidget {
  ...
  const LoginPage({super.key, required this.router, required this.authService});
